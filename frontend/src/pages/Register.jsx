          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="form-group">
              ...
              <div className="relative">
                <User className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[var(--text-muted)] w-5 h-5" />
                <input
                  type="text"
                  id="name"
                  name="name"
            ...
            <div className="form-group">
              ...
              <div className="relative">
                <Mail className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[var(--text-muted)] w-5 h-5" />
                <input
                  type="email"
                  id="email"
                  name="email"
            ...
            <div className="form-group">
              ...
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[var(--text-muted)] w-5 h-5" />
                <input
                  type="password"
                  id="password"
                  name="password"
